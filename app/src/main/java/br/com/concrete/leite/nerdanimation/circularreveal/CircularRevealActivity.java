package br.com.concrete.leite.nerdanimation.circularreveal;
...
public class CircularRevealActivity extends AppCompatActivity {
    ...
    private void showMenu() {
        if (!isOpen) {
            ...
            Animator anim = ViewAnimationUtils.createCircularReveal(layoutButtons, x, y, startRadius, endRadius);
            anim.addListener(new CloseAnimationListener());
            anim.start();
    ...
    class CloseAnimationListener implements Animator.AnimatorListener{
